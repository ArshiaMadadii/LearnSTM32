...
#define MAX30102_SAMPLES_PER_SECOND         100   // must match algorithm FS
#define MAX30102_FIFO_ALMOST_FULL_SAMPLES   17

#define MAX30102_BUFFER_LENGTH \
  ((MAX30102_MEASUREMENT_SECONDS + 1) * MAX30102_SAMPLES_PER_SECOND)

/* =========================
 *  LED calibration
 * ========================= */
#define MAX30102_IR_LED_CURRENT_LOW          0x01
#define MAX30102_RED_LED_CURRENT_LOW         0x01

#define MAX30102_IR_LED_CURRENT_HIGH         0x24   // ~7.2mA
#define MAX30102_RED_LED_CURRENT_HIGH        0x24

/* Finger detect thresholds (IMPORTANT) */
#define MAX30102_IR_VALUE_FINGER_ON_SENSOR   5000
#define MAX30102_IR_VALUE_FINGER_OUT_SENSOR  2000
...
#else
  #error "Invalid MAX30102_SAMPLES_PER_SECOND"
#endif
